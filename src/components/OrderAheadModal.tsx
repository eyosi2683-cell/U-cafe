...
export default function OrderAheadModal({
  ...
  const [loadingText, setLoadingText] = useState('Connecting to Cafe U bar...');
  ...
  const startCheckoutSimulation = () => {
    ...
    setLoadingText('Transmitting ticket to Cafe U counter...');
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-xs text-gray-400 mt-3 leading-relaxed max-w-xs">
                    Your order has been loaded directly into the barista's display queue at Cafe U.
                  </p>
                </div>
