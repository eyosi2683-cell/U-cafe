      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 flex flex-col items-start text-left">
          ...
          >
            ...
            U Street Corridor's Favorite Neighborhood Spot
          </motion.div>
          ...
          >
            Welcome to <span className="text-white font-medium">Cafe U</span>, a cozy neighborhood coffee shop serving La Colombe coffee, fresh bagel sandwiches, and daily juice on the historic U Street Corridor. Whether you're grabbing a quick drink or settling in with friends, find your home with us across from the U Street Metro.
          </motion.p>
          ...
          >
            ...
            <div className="absolute bottom-4 left-4 right-4 bg-[#1E110A]/90 backdrop-blur-md p-4 rounded-xl border border-[#3D2516]/50 flex justify-between items-center text-left">
              <div>
                ...
                <span className="text-sm font-semibold text-white">La Colombe Coffee</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto mt-16 pt-10 border-t border-[#3D2516]/60 grid grid-cols-1 sm:grid-cols-3 gap-6 text-left">
        <div className="flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="text-xs text-[#EFE3C3]/70 mt-1">Smooth, full-bodied coffee brewed daily from La Colombe.</p>
          </div>
        </div>
        <div className="flex gap-4 items-start">
          <div className="w-10 h-10 rounded-xl bg-[#2D1B10] border border-[#3D2516] flex items-center justify-center text-[#C89D7C] shrink-0">
          ...
          <div>
            <h3 className="text-sm font-bold text-white uppercase tracking-wider">Fresh Bagels & Sweets</h3>
            <p className="text-xs text-[#EFE3C3]/70 mt-1">Bagel sandwiches from Bullfrog Bagels and sweets from Sweets by Sam DC.</p>
          </div>
        </div>
        <div className="flex gap-4 items-start">
          <div className="w-10 h-10 rounded-xl bg-[#2D1B10] border border-[#3D2516] flex items-center justify-center text-[#C89D7C] shrink-0">
